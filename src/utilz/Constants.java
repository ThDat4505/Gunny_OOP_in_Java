...
public class Constants {
    ...
    public static class ObjectConstants {
        ...
        public static final int WATER_WIDTH = (int) (Game.SCALE * WATER_WIDTH_DEFAULT);
        public static final int WATER_HEIGHT = (int) (Game.SCALE * WATER_HEIGHT_DEFAULT);
    ...
    public static class EnemyConstants {
        ...
        public static final int CRABBY_DRAWOFFSET_X = (int) (26 * Game.SCALE); //EP16.2
    ...
    public static class UI {
        public static class LFrames {
            public static final int FRAME_SIZE_DEFAULT = 256;
            public static final int FRAME_SIZE = (int) (256 * Game.SCALE);
        }
